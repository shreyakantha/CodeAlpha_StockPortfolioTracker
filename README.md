...
A simple console-based Stock Portfolio Tracker built in **Python**. This program calculates the total investment value based on user-entered stock names and quantities using manually defined stock prices. It allows users to interactively build a portfolio, view individual and total investment values, and optionally save the results to a `.txt` or `.csv` file.
...
- Display of total investment amount
...
```bash
git clone
https://github.com/shreyakantha/CodeAlpha_StockPortfolioTracker
